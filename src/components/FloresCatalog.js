      ...
      <div className="catalog-header">
        <div className="container">
          <nav className="breadcrumb">
            ...
            <span className="breadcrumb-current">Flores</span>
          </nav>
        ...
        <div className="container">
          ...
          <div className="catalog-cta-section">
            <div className="cta-content">
              ...
              <p>Entre em contato conosco para criar um arranjo personalizado especialmente para você!</p>
